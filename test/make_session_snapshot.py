...
DEFAULT_OUT = LOGS_DIR / f"test_session_snapshot_{TIMESTAMP}.yaml"
...
def rotate_snapshots(log_dir: Path, pattern: str = "test_session_snapshot_*.yaml", keep: int = 10) -> None:
